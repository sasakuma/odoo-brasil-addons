...
class L10nBrWebsiteSale(main.WebsiteSale):
    ...
    def _get_mandatory_billing_fields(self):
        ...
        res.remove('city')
        return res + ["cnpj_cpf", "zip", "number",
                      "district", "state_id", "city_id"]
    ...
    @http.route(['/shop/get_cities'], type='json', auth="public", methods=['POST'], website=True)  # noqa: 501
    ...
    @http.route(['/shop/get_states'], type='json', auth="public", methods=['POST'], website=True)  # noqa: 501
    ...
    def checkout_form_validate(self, mode, all_form_values, data):
        ...
        if cnpj_cpf and len(cnpj_cpf) == 18:
            if not validate_cnpj(cnpj_cpf):
                ...
                error_msg.append(_(u'CNPJ Inválido!'))

        elif cnpj_cpf and len(cnpj_cpf) == 14:
            if not validate_cpf(cnpj_cpf):
                errors["cnpj_cpf"] = u"invalid"
                error_msg.append(_(u'CPF Inválido!'))
        ...
        if cnpj_cpf:
            ...
            if existe > 0:
                errors["cnpj_cpf"] = u"invalid"
                error_msg.append(_(u'CPF/CNPJ já cadastrado'))
        ...
        if email:
            ...
            if existe > 0:
                ...
                error_msg.append(_(u'E-mail já cadastrado'))
        ...
        if 'phone' in data and not data['phone']:
            ...
            error_msg.append(u'Informe o seu número de telefone')
    ...
    def search_zip_json(self, zip_code):

        if len(zip) >= 8:
            cep = re.sub('[^0-9]', '', zip_code)
